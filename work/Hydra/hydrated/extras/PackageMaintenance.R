...
OhdsiRTools::checkUsagePackage("testingPackage")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/testingPackage.pdf")
shell("R CMD Rd2pdf ./ --output=extras/testingPackage.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "testingPackage",
                                mode = "description",
